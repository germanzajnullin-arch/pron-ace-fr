import { AlertTriangle, MicOff, WifiOff, VolumeX } from "lucide-react";
...
const ICONS: Record<RecordingError["kind"], React.ReactNode> = {
  ...
  "empty-audio": <VolumeX className="h-5 w-5" aria-hidden />,
  network: <WifiOff className="h-5 w-5" aria-hidden />,
